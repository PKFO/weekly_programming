...
class Player(Entity):
    def __init__(self, pos, groups, obstacle_sprites, create_magic):
        ...
        # stats
        self.stats = {'health': 100, 'energy': 100, 'magic': 5, 'speed': 5}
    ...
    def import_player_assets(self):
        ...
        self.animations = {'up': [], 'down': [], 'left': [], 'right': [], 'idle_up': [], 'idle_right': [], 'idle_left': [], 'idle_down': [],'right_attack':[],'left_attack':[],'up_attack':[],'down_attack':[]}
